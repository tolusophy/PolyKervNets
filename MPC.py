#gotten from Crypten's example and customized for this purpose
#go through the parameters and change the needed parts
...
from Models.PolyAlexNet import PolyAlexNet
from Models.PolyLeNet import PolyLeNet
from Models.PolyResNet import PolyResNet18, PolyResNet34, PolyResNet50, PolyResNet101, PolyResNet152
...
def run_mpc(
    ...
    # **call model**
    model = PolyResNet18(img_channels=3, num_classes=10)
